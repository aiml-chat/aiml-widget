...
`),t=[],s=!1,i=!1;for(let l=0;l<a.length;l++){let p=a[l],n=p.match(/^(#{1,3}) (.+)/);if(n){r();let v=Math.min(n[1].length+2,6);t.push(`<h${v}>${n[2]}</h${v}>`);continue}let u=p.match(/^[-*] (.+)/);if(u){s||(t.push("<ul>"),s=!0),t.push(`<li>${u[1]}</li>`);continue}let h=p.match(/^\d+\. (.+)/);if(h){i||(t.push("<ol>"),i=!0),t.push(`<li>${h[1]}</li>`);continue}r(),p.trim()===""?t.push(""):t.push(`<p>${p}</p>`)}r();function r(){s&&(t.push("</ul>"),s=!1),i&&(t.push("</ol>"),i=!1)}return t.join(`
`).replace(/<\/p>\n<p>/g,"<br>").replace(/\n{2,}/g,`
`)}function P(g){return g&&g.replace(/[ \t]*(?<![A-Za-z0-9])\[\d{1,2}\](?:[ \t]*\[\d{1,2}\])*/g,"").replace(/[ \t]*(?<![A-Za-z0-9])\[\d{0,2}$/g,"")}function V(g){return g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var y={chat:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',close:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',send:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>',bot:"\u{1F916}",minus:'<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="5" y1="12" x2="19" y2="12"/></svg>',maximize:'<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" y1="3" x2="14" y2="10"/><line x1="3" y1="21" x2="10" y2="14"/></svg>',restore:'<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="4 14 10 14 10 20"/><polyline points="20 10 14 10 14 4"/><line x1="14" y1="10" x2="21" y2="3"/><line x1="3" y1="21" x2="10" y2="14"/></svg>',menu:'<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><line x1="4" y1="7" x2="20" y2="7"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="17" x2="20" y2="17"/></svg>',sparkles:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3z"/><path d="M19 15l.7 2.3L22 18l-2.3.7L19 21l-.7-2.3L16 18l2.3-.7L19 15z"/></svg>'},D=g=>`<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${g}</svg>`,X={alert:D('<path d="M10.3 3.9L1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>'),clock:D('<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>'),info:D('<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>')},k=g=>`<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">${g}</svg>`,x={msg:k('<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>'),spark:k('<path d="M12 3v4M12 17v4M3 12h4M17 12h4M6 6l2 2M16 16l2 2M18 6l-2 2M8 16l-2 2"/>'),code:k('<polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>'),arrow:k('<line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>'),shield:k('<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>'),lock:k('<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>'),check:k('<polyline points="20 6 9 17 4 12"/>'),x:k('<circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/>'),loader:k('<line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="4.9" y1="4.9" x2="7.8" y2="7.8"/><line x1="16.2" y1="16.2" x2="19.1" y2="19.1"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="4.9" y1="19.1" x2="7.8" y2="16.2"/><line x1="16.2" y1="7.8" x2="19.1" y2="4.9"/>'),user:k('<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>')},J={Support:{accent:"#4F46E5",icon:"msg"},Sales:{accent:"#7C3AED",icon:"spark"},Technical:{accent:"#0F766E",icon:"code"}},Q={accent:"#78716C",icon:"spark"},N=g=>J[g]||Q,H=class{constructor(e){this.config=e,this.host=null,this.shadow=null,this.isOpen=!1,this._streaming=!1,this._streamingEl=null,this._streamBuffer="",this._currentBotMsg=null,this._lastAgent=null,this._confirmCards={},this._toolGroup=null,this._toolRows={}}mount(){this.host=document.createElement("div"),this.host.setAttribute("id","aiml-widget-host"),this.host.setAttribute("data-theme",this.config.theme||"auto"),document.body.appendChild(this.host),this.shadow=this.host.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=R,this.shadow.appendChild(e);let a={none:"0px",md:"12px",xl:"20px"},t=[];this.config.primaryColor&&t.push(`--aiml-primary: ${this.config.primaryColor};`),this.config.radius in a&&t.push(`--aiml-radius: ${a[this.config.radius]};`),t.push(`--aiml-offset-x: ${this.config.offsetX??24}px;`),t.push(`--aiml-offset-y: ${this.config.offsetY??24}px;`),this.config.zIndex&&t.push(`--aiml-z: ${this.config.zIndex};`),e.textContent+=`:host { ${t.join(" ")} }`,this.shadow.appendChild(this._buildTrigger()),this.config.launcherLabel&&this.shadow.appendChild(this._buildLauncherLabel()),this.shadow.appendChild(this._buildWindow()),this._bindEvents(),this._focusTrap()}_buildTrigger(){let e=document.createElement("button"),a=this.config.launcherSize==="sm"?" aiml-sz-sm":this.config.launcherSize==="lg"?" aiml-sz-lg":"";e.className=`aiml-trigger${this.config.position==="left"?" aiml-left":""}${a}`,e.setAttribute("aria-label","Open AI chat assistant"),e.setAttribute("aria-expanded","false"),e.setAttribute("aria-controls","aiml-chat-window");let t=this.config.launcherIconUrl?`<img class="aiml-trigger-img" src="${A(this.config.launcherIconUrl)}" alt="" />`:y.chat;return e.innerHTML=`
      <span class="aiml-icon-open" aria-hidden="true">${t}</span>
      <span class="aiml-icon-close" aria-hidden="true">${y.close}</span>`,e}_buildLauncherLabel(){let e="aiml_label_dismissed",a=!1;try{a=sessionStorage.getItem(e)==="1"}catch{}let t=document.createElement("div");return a||(t.className=`aiml-launcher-label${this.config.position==="left"?" aiml-left":""}`,t.innerHTML=`<span>${f(this.config.launcherLabel)}</span><button class="aiml-label-dismiss" aria-label="Dismiss">${y.close}</button>`,t.querySelector("span").addEventListener("click",()=>this.open()),t.querySelector(".aiml-label-dismiss").addEventListener("click",s=>{s.stopPropagation(),t.remove();try{sessionStorage.setItem(e,"1")}catch{}}),this._labelEl=t),t}_buildWindow(){let e=document.createElement("div");e.className=`aiml-window aiml-hidden${this.config.position==="left"?" aiml-left":""}`,e.setAttribute("id","aiml-chat-window"),e.setAttribute("role","dialog"),e.setAttribute("aria-label","AI Chat Assistant"),e.setAttribute("aria-modal","false");let a=this.config.avatarUrl?`<img class="aiml-avatar-img" src="${A(this.config.avatarUrl)}" alt="" />`:y.bot,t=!!this.config.agentMode,s=N("Support").accent,i=this.config.title||(t?"AI agent team":"AI Assistant"),r=t?'Now: <span class="aiml-header-now" style="color:#fff">Support</span>':f(this.config.subtitle||"Ask me anything");return e.innerHTML=`
      <div class="aiml-header">
        ...
        <div class="aiml-header-info">
          <div class="aiml-header-title">${A(i)}</div>
          <div class="aiml-header-subtitle">${r}</div>
        </div>
        <span class="aiml-label" title="You are interacting with an AI">AI</span>
        ${t?`<button class="aiml-hbtn aiml-menu-btn" aria-label="More options" aria-haspopup="true" aria-expanded="false" title="More">${y.menu}</button>`:""}
        <button class="aiml-hbtn aiml-max-btn" aria-label="Full screen" title="Full screen">${y.maximize}</button>
        <button class="aiml-hbtn aiml-close-btn" aria-label="Minimize chat" title="Minimize">${y.minus}</button>
      ...
      <div class="aiml-input-area">
        <textarea
          class="aiml-input"
          placeholder="${A(this.config.placeholder||(t?"Message the team\u2026":"Ask a question\u2026"))}"
          rows="1"
      ...
      <p class="aiml-lead-success aiml-hidden" role="status">${i?"Thanks \u2014 a teammate will email you shortly.":"Thanks! We'll be in touch."}</p>`;let l=r.querySelector(".aiml-lead-email"),p=r.querySelector(".aiml-lead-submit"),n=r.querySelector(".aiml-lead-error"),u=r.querySelector(".aiml-lead-success");p.addEventListener("click",async()=>{let h=l.value.trim();if(!h||!h.includes("@")){n.classList.remove("aiml-hidden");return}n.classList.add("aiml-hidden"),p.disabled=!0;try{await a(h,e),l.classList.add("aiml-hidden"),p.classList.add("aiml-hidden"),u.classList.remove("aiml-hidden")}catch{p.disabled=!1,n.textContent="Failed to submit. Please try again.",n.classList.remove("aiml-hidden")}}),s.appendChild(r),this._scrollToBottom(),setTimeout(()=>l.focus(),50)}_scrollToBottom(){let e=this.shadow.querySelector(".aiml-messages");e&&(e.scrollTop=e.scrollHeight)}};function f(g){return String(g).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function A(g){return String(g||"").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}(function(){"use strict";if(window.__aimlWidgetLoaded)return;window.__aimlWidgetLoaded=!0;let g="Hi! \u{1F44B} I'm this site's AI assistant. Ask me anything \u2014 I'll answer from this site's own content and show you the sources.",e=document.currentScript||document.querySelector("script[data-api-key]");if(!e){console.warn("[AIML] No script tag found with data-api-key attribute.");return}let a=e.getAttribute("data-api-key"),t=e.getAttribute("data-website-id"),s=e.getAttribute("data-api-url")||"https://api.aiml.chat",i=o=>e.getAttribute("data-"+o),r=i("suggested-questions"),l=r?r.split("|").map(o=>o.trim()).filter(Boolean):null;if(!a){console.warn("[AIML] Missing data-api-key on script tag.");return}let p=o=>o&&/^(#[0-9a-fA-F]{3,8}|(rgb|hsl)a?\([\d\s.,%\/]+\))$/.test(o.trim())?o.trim():null,n=o=>o&&/^https:\/\/[^\s"'<>]+$/i.test(o.trim())?o.trim():null,u=(o,c,O,b)=>{let m=parseInt(o,10);return Number.isFinite(m)?Math.min(b,Math.max(O,m)):c},h=(o,c)=>c.includes(o)?o:null,v=`aiml_session_${t||"default"}`;function S(){try{let o=sessionStorage.getItem(v);return o?JSON.parse(o):{conversationId:null,history:[],visitorId:T()}}catch{return{conversationId:null,history:[],visitorId:T()}}}function _(o){try{sessionStorage.setItem(v,JSON.stringify(o))}catch{}}function T(){return"v-"+Math.random().toString(36).slice(2)+Date.now().toString(36)}async function I(){try{let o=await fetch(`${s}/v1/widgets/${encodeURIComponent(a)}/config`,{headers:{"X-Api-Key":a}});if(o.ok)return await o.json()}catch{}return{}}async function z(){let o=await I(),c=S(),O=l??o.suggestedQuestions??[],b={position:h(i("position"),["left","right"])||o.position||"right",theme:h(i("theme"),["light","dark","auto"])||o.theme||"auto",primaryColor:p(i("primary-color"))||p(o.primaryColor)||null,title:i("title")||o.title||null,subtitle:i("subtitle")||o.subtitle||null,placeholder:o.placeholder||null,greeting:i("greeting")||o.greeting||null,showBranding:o.showBranding!==!1,suggestedQuestions:O,avatarUrl:n(i("avatar"))||n(o.avatarUrl)||null,launcherIconUrl:n(i("launcher-icon"))||n(o.launcherIconUrl)||null,launcherSize:h(i("launcher-size"),["sm","md","lg"])||o.launcherSize||"md",launcherLabel:i("launcher-label")??o.launcherLabel??null,radius:h(i("radius"),["none","md","xl"])||o.radius||"md",offsetX:u(i("offset-x")??o.offsetX,24,0,400),offsetY:u(i("offset-y")??o.offsetY,24,0,400),zIndex:u(i("z-index")??o.zIndex,2147483647,1,2147483647),autoOpenDelaySec:u(i("auto-open")??o.autoOpenDelaySec,0,0,600),hideOnMobile:(i("hide-mobile")??String(o.hideOnMobile??!1))==="true",agentMode:i("mode")==="agent"||o.assistantMode==="agent",showAgentName:(i("show-agent-name")??String(o.showAgentName??!0))!=="false"};if(b.hideOnMobile&&window.matchMedia("(max-width: 640px)").matches)return;let m=new H(b),E=new B(s,a);m.mount();let U=()=>{b.agentMode&&!b.greeting?m.showAgentWelcome():m.showGreeting(b.greeting||g),m.showSuggestedChips(b.suggestedQuestions,"Try asking:")};U(),m.onTalkToHuman=t?()=>m.showLeadCaptureForm("",(M,w)=>E.captureLead(t,M,w),"human"):null,m.onClear=()=>{c.conversationId=null,c.history=[],_(c),U()},b.autoOpenDelaySec>0&&!c.autoOpened&&setTimeout(()=>{m.isOpen||m.open(),c.autoOpened=!0,_(c)},b.autoOpenDelaySec*1e3),m.host.addEventListener("aiml:send",async M=>{let w=M.detail.text;m.hideWelcomeState(),c.history.push({role:"user",content:w}),_(c),m.appendUserMessage(w),m.startBotMessage();let C="",q=!1,$=d=>{q||(q=!0,m.finishBotMessage(d),C&&(c.history.push({role:"assistant",content:C}),_(c)))};await E.send(w,c.history.slice(0,-1),c.conversationId,c.visitorId,{onConversation(d){d&&c.conversationId!==d&&(c.conversationId=d,_(c))},onToken(d){C+=d,m.appendToken(d)},onCitations(d){$(d)},onAgent(d){m.setAgent(d)},onHandoff(d){m.showHandoff(d)},onTool(d){m.showTool(d)},onConfirm(d){m.showConfirmCard(d,L=>G(d.id,L))},onConfirmResult(d){m.showConfirmResult(d)},onEscalate(){t&&m.showEscalate(()=>m.showLeadCaptureForm(w,(d,L)=>E.captureLead(t,d,L),"human"))},onNoAnswer(){$([]),m.showNoAnswerHelp(w,b.suggestedQuestions,t?(d,L)=>E.captureLead(t,d,L):null)},onDone(){$([])},onError(d,L){if(d==="noContent"&&t){m.showLeadCaptureForm(w,async(W,Y)=>{await E.captureLead(t,W,Y)});return}if(d==="network"){m.showStatus("network","Couldn't connect. Check your internet and try again.");return}if(d==="rateLimit"){m.showStatus("rate","You've asked a lot! Try again in a moment.");return}if(d==="quota"){m.showStatus("quota","This site's monthly limit has been reached.");return}let F={auth:"Authentication failed. Please check your API key.",noContent:"No answer found. Please contact us directly.",stream:"Stream interrupted. Please try again.",server:"Server error. Please try again later."};m.showStatus("error",F[d]||"Something went wrong. Please try again.")}},{mode:b.agentMode?"agent":void 0})});async function G(M,w){m.startBotMessage();let C="",q=!1,$=()=>{q||(q=!0,m.finishBotMessage([]),C&&(c.history.push({role:"assistant",content:C}),_(c)))};await E.send("",c.history,c.conversationId,c.visitorId,{onToken(d){C+=d,m.appendToken(d)},onCitations(){$()},onConfirmResult(d){m.showConfirmResult(d)},onDone(){$()},onError(){m.showStatus("error","Could not complete that action. Please try again.")}},{mode:"agent",approveActionId:M,approveAllow:w})}window.AIML={open:()=>m.open(),close:()=>m.close(),toggle:()=>m.toggle(),clearHistory:()=>{c.history=[],c.conversationId=null,_(c)}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",z):z()})();})();
